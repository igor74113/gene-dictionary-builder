...
⚠️ **This file is treated as frozen by default.**  
...
| Weighting / prioritization | ⚠️ Optional | ✅ Yes |
| Annotation & explanation | ✅ (decode indices) | ✅ (clinical context) |
...
### Fresh directory
If neither file exists, **both dictionaries**
